...
`}return r+="};",new Function(t.join(),r).apply(void 0,i)},u.prototype._createReader=function(){var t=[],i=[this.recordConstructor],e,r;for(e=0,r=this.fields.length;e<r;e++)t.push("t"+e),i.push(this.fields[e].type);var n=this._getConstructorName(),o="return function read"+n+`(t) {
`;return o+="  return new "+n+`(
    `,o+=t.map(function(s){return s+"._read(t)"}).join(`,
    `),o+=`
  );
};`,t.unshift(n),new Function(t.join(),o).apply(void 0,i)},u.prototype._createSkipper=function(){var t=[],i="return function skip"+this._getConstructorName()+`(t) {
`,e=[],r,n;for(r=0,n=this.fields.length;r<n;r++)t.push("t"+r),e.push(this.fields[r].type),i+="  t"+r+`._skip(t);
`;return i+="}",new Function(t.join(),i).apply(void 0,e)},u.prototype._createWriter=function(){var t=[],i=this._getConstructorName(),e="return function write"+i+`(t, v) {
